...
- [ ] 5.1 - Testar atalho `CTRL+SHIFT+D`
- [ ] 5.2 - Testar drag & drop funcionando
- [ ] 5.3 - Testar GameStateTab exibindo dados corretos
- [ ] 5.4 - Verificar performance (não deve travar o jogo)
- [ ] 5.5 - Testar em diferentes resoluções
